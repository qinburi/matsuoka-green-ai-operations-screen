...
export const versionHistory: readonly VersionRelease[] = [
  {
    ...
    boundaries: [
      ...
      '检查顺序、方案预案和责任岗位均为建议；处理记录仅保存于当前浏览器作为演示，不实现正式任务分派、消息推送、MES/QMS回写或关闭流程。',
    ...
    changes: [
      ...
      {
        id: 'v4-problem-closure-checklist',
        changedAt: '2026-08-13',
        category: '问题闭环',
        title: '新增问题闭环清单与验证通过标识',
        description: '区分检查动作完成与问题验证解决；只有验证信息完整且确认通过的问题显示醒目绿色对钩。',
      },
    ],
  },
  {
